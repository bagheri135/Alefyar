<head>
    ...
    <link href="{{url('/front/fonts/fontawesome/css/all.css')}}" rel="stylesheet">
    <link href="{{url('/front/fonts/WebFonts/css/fontiran.css')}}" rel="stylesheet">
    <link href="{{url('/front/fonts/WebFonts/css/style.css')}}" rel="stylesheet">
    <link href="{{url('/front/css/sweetalert2.min.css')}}" rel="stylesheet">
